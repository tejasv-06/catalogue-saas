...
export default async function Navbar() {
  ...
  return (
    <nav className="bg-slate-950/80 backdrop-blur-md border-b border-slate-800/80 text-white">
      <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            ...
            className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2.5 rounded-xl text-sm font-medium shadow-lg shadow-blue-500/20 transition-colors"
          >
