...
// Palette: indigo (primary actions), emerald (approve/success), slate (neutral
// surfaces/text), red/amber kept for destructive/warning semantics.

const focusRing = 'focus:outline-none focus:ring-2 focus:ring-offset-2'

export const buttonPrimaryClass =
  `bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-sm px-4 py-2.5 rounded-lg shadow-sm ${focusRing} focus:ring-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed transition`
...
export const buttonPrimarySmallClass =
  `bg-indigo-600 hover:bg-indigo-700 text-white px-2 py-1 rounded-lg text-xs font-medium ${focusRing} focus:ring-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed transition`
...
export const linkButtonClass =
  `text-sm text-slate-600 underline hover:text-slate-900 ${focusRing} focus:ring-indigo-500/40 rounded transition`
...
export const inputClass =
  'border border-slate-300 rounded-lg p-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition'
...
export const selectClass =
  'bg-slate-50 border border-slate-300 rounded-lg px-3 py-2 text-sm text-slate-800 font-medium hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition'
