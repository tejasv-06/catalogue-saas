...
| Flipkart | Title ≤100 · Description ≤2000 · Key Features ≤5 items/100 chars · Search Keywords ≤5 items/3 words each | N/A |
...
- Null/undetected individual attributes are simply omitted from the list, not shown as blank or "N/A".
